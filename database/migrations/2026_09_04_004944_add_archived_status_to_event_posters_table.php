...
return new class extends Migration
{
     ...
     * tanpa doctrine/dbal, jadi tabel dibangun ulang dengan nilai status "archived" baru.
     */
    public function up(): void
    {
        ...
        DB::statement('
            ...
            SELECT id, user_id, image_path, category, city, kecamatan, province, event_date, status, created_at, updated_at
            FROM event_posters
        ');
    ...
    public function down(): void
    {
        ...
        DB::statement("
            ...
            SELECT id, user_id, image_path, category, city, kecamatan, province, event_date,
                CASE status WHEN 'archived' THEN 'rejected' ELSE status END,
